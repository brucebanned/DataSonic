...
st.set_page_config(page_icon="chat2vis.png",layout="wide",page_title="DataSonic")


st.markdown("<h1 style='text-align: center; font-weight:bold; padding-top: 0rem;'> \
            DataSonic</h1>", unsafe_allow_html=True)
st.markdown("<h2 style='text-align: center;padding-top: 0rem;'>Interactive Visualisations </h2>", unsafe_allow_html=True)
...
openai_key = key_col1.text_input(label = "OpenAI Key:", help="Required for ChatGPT-4, ChatGPT-3.5, GPT-3, GPT-3.5 Instruct.",type="password")
